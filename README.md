...
ReMow is a modular, bolt-on kit that reuses your mower's engine, deck, and self-propel transmission. Instead of buying a $2,000+ robot mower, you add a controller module, a small engine-driven alternator for power, a steering actuator, and an actuator to engage the existing self-propel drive. Start with basic remote control and upgrade to mapped autonomous routes and camera-based object detection over time.
...
- **Reuse what you own.** Keep the mower's engine, deck, wheels, and drivetrain.
...
- [Electrical: alternator power, wiring, pinouts, power budget](docs/electrical.md)
...
├── README.md
├── LICENSE
├── docs/            # Full layout plan (tiers, architecture, mechanical, electrical, software, BOM, roadmap)
